          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  <label htmlFor="ex-regirtration-name" className="form-label">Full Name</label>
                  <input type="text" className="form-control ex-regirtration-name" id="ex-regirtration-name" aria-describedby="ex-regirtration-name-help" onChange={e=>setUserName(e.target.value)}/>
                </div>
                <div className="mb-3">
